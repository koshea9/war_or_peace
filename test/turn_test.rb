...
class TurnTest < Minitest::Test
  ...
  def test_it_has_readable_attributes
    ...
    assert_equal "Queen", @card6.value
    assert_equal 2, @card8.rank
  ...
  def test_it_can_have_basic_winner
    @turn.player1
    @turn.player2
  ...
  def test_it_can_pile_cards_for_basic_winner
    @turn.player1
    @turn.player2
  ...
  def test_it_can_award_spoils_for_basic_winner
    @turn.player1
    @turn.player2
  ...
  def test_it_can_finish_basic_round
    @turn.player1
    @turn.player2
